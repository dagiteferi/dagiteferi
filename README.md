...
<img align="left" src="https://media.giphy.com/media/xUA7bdpLxQhsSQdyog/giphy.gif" width="55px" alt="journey gif" />

&nbsp; **It started with a single spark.**

<br/>

My journey into tech began when my **ICT teacher** first showed me how software shapes the digital world. That spark turned into obsession. In **high school**, I was already building websites — teaching myself **HTML, CSS, and JavaScript**, then diving into **React**, **Node.js**, and **Express.js** on my own.
...
```text
🤖  Agentic AI Systems     ████████████████████   LangGraph, CrewAI, OpenAI
⚙️  Backend Microservices  ████████████████████   Go, FastAPI, gRPC, Kafka
🧠  ML & Data Pipelines    ███████████████░░░░░   Scikit-Learn, Pandas, YOLO
🌐  Full-Stack Web Apps    █████████████░░░░░░░   React, Node.js, PostgreSQL
☁️  DevOps & Infra         ████████████░░░░░░░░   Docker, Nginx, CI/CD
```
...
| Pattern | Description |
|---|---|
| 🏢 **Domain-Driven Design (DDD)** | Modeling complex business domains with bounded contexts |
| ⚡ **Event-Driven Architecture (EDA)** | Kafka-based async microservices communication |
| 🧅 **Hexagonal / Clean Architecture** | Ports & adapters for testable, framework-agnostic code |
| 📮 **CQRS + Outbox Pattern** | Reliable command/query separation with transactional messaging |
| 🤖 **RAG Pipelines** | Retrieval-Augmented Generation for context-aware LLM responses |
| 🔗 **Agentic AI Systems** | Autonomous multi-agent orchestration with LangGraph & CrewAI |
...
**1st Place · Harvard HSIL Hackathon 2026 · 60 Finalists**
...
### 🎓 AI Intelligent Learning & Assessment System
**1,000+ Concurrent Users · LangGraph + Groq (Llama 3)**
...
### 💳 End-to-End Credit Scoring Model
**~40% reduction in default rates · 35% improved loan approval efficiency**
...
**20% reduction in manual categorization · 50% less deployment effort**
...
### 📖 Amharic Bible Reader — Browser Extension *(Open Source)*
...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:0d47a1,50:1a1f3a,100:0d1117&height=120&section=footer&text=Open%20to%20collaborations%20on%20impactful%20AI%20systems&fontSize=16&fontColor=90caf9&fontAlignY=60&animation=fadeIn" />
